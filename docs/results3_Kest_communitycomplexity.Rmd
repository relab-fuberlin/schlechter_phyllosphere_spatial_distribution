...
```{r figure_5, fig.id=TRUE, fig.cap="Bacterial population density in the arabidopsis phyllosphere"}
...
# Save plot
ggsave(here("results", "figure_5.png"), width = 12, height = 5)
ggsave(here("results", "figure_5.tiff"), width = 12, height = 5)
...
```{r figure_s3, warning=FALSE, fig.id=TRUE, fig.cap="Frequency plots K"}
...
# Save plot
ggsave(here("results", "figure_s3.png"), width = 12, height = 8)
ggsave(here("results", "figure_s3.tiff"), width = 12, height = 8)
...
# Save plot
plt.pattern
ggsave(here("results", "figure_s4.png"), width = 6, height = 5)
ggsave(here("results", "figure_s4.tiff"), width = 6, height = 5)
