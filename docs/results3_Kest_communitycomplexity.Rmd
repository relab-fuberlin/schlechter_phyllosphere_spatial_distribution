...
```{r figure_main_5, fig.id=TRUE, fig.cap="Bacterial population density in the arabidopsis phyllosphere", dev = c("png", "tiff"), fig.dim=c(12,5)}
...
```{r plot_sup_pattern, fig.id=TRUE, fig.cap="Spatial patterns", dev = c("png", "tiff"), fig.dim=c(6,6)}
...
```{r figure_supplemental_5, warning=FALSE, fig.id=TRUE, fig.cap="Frequency plots K", dev = c("png", "tiff"), fig.dim=c(12,8)}
