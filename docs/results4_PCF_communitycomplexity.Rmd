...
To further dissect these differences, we grouped the species pairs based on their identity, as a pair was composed of either two methylobacteria (MM), a methylobacterium and a sphingomonad (MS), or two sphingomonads (SS). We noticed that randomness was high at 7 dpi () for pairs belonging to an S3 community, and it was associated with pairs of species containing at least one *Methylobacterium* species (MM and MS) (Fig. XXB). However, the randomness of these pairs decreased over time and became comparable to S2 at 14 dpi. The decrease in aggregation was only observed in MM pairs at 14 dpi. By contrast, pairs composed of only *Sphingomonas* species (SS) were not different between S2 and S3.
