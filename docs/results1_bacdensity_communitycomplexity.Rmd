...
```{r figure_2, fig.id=TRUE, fig.cap="Bacterial population density in the arabidopsis phyllosphere"}
...
# Save plot
ggsave(here("results", "figure_2.png"), width = 7, height = 5)
ggsave(here("results", "figure_2.tiff"), width = 7, height = 5)
...
# Save plot  
ggsave(here("results", "figure_s2.png"), width = 5, height = 4.5)
ggsave(here("results", "figure_s2.tiff"), width = 5, height = 4.5)
```
